...
COMPUTE_CAPABILITY_ARGS = [  # Updated for CUDA 13.0 compatibility
    ...
    "-gencode=arch=compute_86,code=sm_86",  # RTX 3050 support
    "-gencode=arch=compute_89,code=sm_89",  # Future RTX 40 series support
    "--ptxas-options=-v",
    "-c",
